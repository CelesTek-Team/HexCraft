...
public class TileCrystalSeparator extends TileEntity implements ISidedInventory, ITileHexEnergyDrain {

    /**** Static Values ****/

    public static final String ID = "tileCrystalSeparator";

    private static final String INVENTORY_NAME = "container.crystalSeparator";
    ...
    public void setSources(ArrayList<HexDevice> energySources) {
        ...
        if (HexConfig.cfgGeneralMachineNetworkDebug && HexConfig.cfgGeneralNetworkDebug)
            System.out.println("[Crystal Separator] (" + xCoord + ", " + yCoord + ", " + zCoord + "): Sources received.");
        recheckSources();
    }
    ...
    private boolean canProcess() {
        if (this.inventory[0] == null)
            ...
            ItemStack itemStack = HexProcessingCrystalSeparator.processing().getProcessingResult(inventory[0]);
            if (itemStack == null)
