...
public class BlockEngineeredHexoriumBlock extends HexBlockMT implements IBlockHexDyable {
    ...
    public static final String ID_WHITE = "blockEngineeredHexoriumBlockWhite";
     ...
     */
    public BlockEngineeredHexoriumBlock(String blockName, int variant) {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        if(this == HexBlocks.blockEngineeredHexoriumBlockRainbow || this == HexBlocks.blockEngineeredHexoriumBlockWhiteRainbow)
