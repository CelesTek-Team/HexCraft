...
public class BlockHexoriumFurnace extends HexBlockContainer implements IHexBlock, IBlockHexEnergyDrain {
    ...
    public static void registerBlocks() {
        if (HexConfig.cfgFurnaceEnable) {
            GameRegistry.registerBlock(new BlockHexoriumFurnace(ID), ID);
        }
    }
    ...
    public static void registerRecipes() {
        if (HexConfig.cfgFurnaceEnable) {
            ...
            Item component = HexItems.itemHeatingArray;
