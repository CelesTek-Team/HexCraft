...
public class BlockFramedHexoriumBlock extends HexBlockMT implements IBlockHexDyable {

    // Block ID
    public static final String ID_BLACK = "blockFramedHexoriumBlock";
    public static final String ID_WHITE = "blockFramedHexoriumBlockWhite";
     ...
     */
    public BlockFramedHexoriumBlock(String blockName, int variant) {
        super(Material.iron);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        if(this == HexBlocks.blockFramedHexoriumBlockRainbow || this == HexBlocks.blockFramedHexoriumBlockWhiteRainbow)
